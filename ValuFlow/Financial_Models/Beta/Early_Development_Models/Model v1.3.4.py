...
# -- Previous Model = v1.3.3
# -- Removed terminal input() prompts for TICKER and ICR_METHOD
# -- Both are now defined directly in Section 0 for cleaner execution
# -- Updated script comments to reflect ticker-agnostic methodology
...
# -- Next:   Use Kd to discount debt cash flows -> Dmv

...
qualitative analysis in three clearly labeled sections:

(1) Risk Profile — what the metrics imply about the company's systematic and idiosyncratic risk
(2) Industry Dynamics — key sector-level forces driving or suppressing systematic risk
(3) Company-Specific Factors — recent company news, industry developments, or macro events
    that materially affect this ticker

Write in clean prose paragraphs only. No markdown headers, no bullet points, no bold text.
Be direct and opinionated. Each section should be 3-5 sentences. Do not hedge unnecessarily.
""".strip()

...
Your process:
Step 1 — Use web search to research the company and gather current facts.
Step 2 — Close the search results mentally. Do not look at them again.
Step 3 — Write the three sections entirely from your own understanding of what you learned.
          Treat the search results as background reading, not as text to draw from.
          Every word in your output must be original prose you composed yourself.
...
(3) Company-Specific Factors: the most material recent developments affecting this ticker,
    grounded in what you found via search but written entirely in your own words.
...
- No section separators or blank lines between sections.
